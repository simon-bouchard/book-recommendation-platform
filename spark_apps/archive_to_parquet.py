...
def main():
    spark = (
        SparkSession.builder.appName("enrichment-bronze-archival")
    ...
    print("  Results → s3a://enrichment-bronze/enrich.results.v1/")
    print("  Errors  → s3a://enrichment-bronze/enrich.errors.v1/")
    print("\n")
