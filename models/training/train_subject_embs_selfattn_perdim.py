...
class SelfAttnPerDimModel(nn.Module):
...
def main():
    ...
    torch.save(state, "models/data/subject_attention_components_selfattn_perdim.pth")
    print("✅ Saved to models/data/subject_attention_components_selfattn_perdim.pth")
