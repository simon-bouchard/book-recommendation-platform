...
class TestSubjectHybrid:
    """Tests for subject_hybrid_pool retrieval tool."""

    def test_returns_results_for_subject_indices(self, db_session: Session):
        """
        ...
        result = subject_hybrid.invoke({"fav_subjects_idxs": [1, 2, 3], "top_k": 10})
    ...
    def test_returns_standardized_fields(self, db_session: Session):
        ...
        result = subject_hybrid.invoke({"fav_subjects_idxs": [5, 10], "top_k": 5})
    ...
    def test_uses_user_favorite_subjects_when_empty_list(self, db_session: Session):
        """
        ...
        result = subject_hybrid.invoke({"fav_subjects_idxs": [], "top_k": 10})
    ...
    def test_clamps_top_k_upper_bound(self, db_session: Session):
        ...
        result = subject_hybrid.invoke({"fav_subjects_idxs": [1, 2], "top_k": 1000})
    ...
    def test_clamps_top_k_lower_bound(self, db_session: Session):
        ...
        result = subject_hybrid.invoke({"fav_subjects_idxs": [1], "top_k": 0})

        assert len(result) == 1

    def test_clamps_subject_weight(self, db_session: Session):
        """
        ...
        result_high = subject_hybrid.invoke(
            {"fav_subjects_idxs": [1, 2], "top_k": 5, "subject_weight": 1.5}
        )
        result_low = subject_hybrid.invoke(
    ...
    def test_returns_error_without_database(self):
        ...
        result = subject_hybrid.invoke({"fav_subjects_idxs": [1, 2], "top_k": 10})

        assert isinstance(result, list)
        assert "error" in result[0]

    def test_returns_error_without_subjects_and_no_user(self, db_session: Session):
        """
...
class TestAlsRecs:
    """Tests for als_recs retrieval tool (requires authenticated user)."""

    def test_returns_results_for_authenticated_user(self, db_session: Session):
        """
        ...
        result = als_recs.invoke({"top_k": 10})
    ...
    def test_returns_standardized_fields(self, db_session: Session):
        ...
        result = als_recs.invoke({"top_k": 5})
    ...
    def test_clamps_top_k_upper_bound(self, db_session: Session):
        ...
        result = als_recs.invoke({"top_k": 1000})
    ...
    def test_clamps_top_k_lower_bound(self, db_session: Session):
        ...
        result = als_recs.invoke({"top_k": 0})

        assert len(result) == 1

    def test_returns_error_without_authentication(self, db_session: Session):
        """
