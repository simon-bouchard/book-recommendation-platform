...
class TestTwoPoolArchitecture:
    ...
    def test_filtering_can_be_disabled(self, monkeypatch, mock_als_factors, mock_book_meta):
        """Should be able to disable candidate filtering."""
        service = SimilarityService()
