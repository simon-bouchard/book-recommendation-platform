...
def judge_response(query: str, response_text: str, history: List[Dict], judge_llm) -> Dict[str, Any]:
    """
...
def evaluate(test_cases: List[Dict], agent: ResponseAgent, judge_llm) -> Dict[str, Any]:
    ...
    for test in test_cases:
        ...
        try:
            ...
            if not agent_success or "having trouble" in response_text.lower() or "error:" in response_text.lower():
                agent_success = False
...
def main():
    ...
    eval_results = evaluate(test_cases, agent, judge_llm)
