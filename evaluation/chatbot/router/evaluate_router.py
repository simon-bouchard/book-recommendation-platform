...
async def evaluate_router(test_queries: Dict[str, List[Dict]], router: RouterLLM) -> Dict[str, Any]:
    """
    ...
    for category, queries in test_queries.items():
        ...
        for test_case in queries:
            ...
            turn_input = TurnInput(
                user_text=query, full_history=[], profile_allowed=False, user_num_ratings=0
            )

            # Classify
            plan = await router.classify(turn_input)
            actual = plan.target
