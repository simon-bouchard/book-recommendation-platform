...
class DocsTools:
    ...
    def _create_help_manifest_tool(self) -> ToolDefinition:
        ...
        return tool(
            name="help_manifest",
            description="List all available help documents with metadata",
            category=ToolCategory.DOCS,
        )(help_manifest)
    
    def _create_help_read_tool(self) -> ToolDefinition:
        ...
        return tool(
            name="help_read",
            description="Read a help document by alias or filename",
            category=ToolCategory.DOCS,
        )(help_read)
