...
class StreamChunk(BaseModel):
    ...
    Types:
        - status: Status update (e.g., "Analyzing request...")
        - token: Individual token of final response text
        - complete: Final completion with full result data
    """

    type: Literal["status", "token", "complete"]
