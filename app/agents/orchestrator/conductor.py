        ...
        *,
        ...
        try:
            ...
            if hasattr(agent, "execute_stream"):
                ...
                # Agent doesn't support streaming - execute synchronously and yield result
                append_chatbot_log(f"Agent does not support streaming, executing synchronously...")
                yield StreamChunk(type="status", content="Processing request...")
                ...
                # Yield the text as tokens (simple character-by-character streaming)
