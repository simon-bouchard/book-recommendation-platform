...
class AgentRequest:
    ...
    def with_context(self, **kwargs) -> AgentRequest:
        ...
        new_context = ExecutionContext(
            ...
            session_data={**self.context.session_data, **kwargs.get('session_data', {})},
            user_preferences={**self.context.user_preferences, **kwargs.get('user_preferences', {})},
            execution_metadata={**self.context.execution_metadata, **kwargs.get('execution_metadata', {})}
        )
        return AgentRequest(
