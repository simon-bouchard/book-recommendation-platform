...
This site is a **machine learning–powered book recommender**. You can:
...
---
**Note:** This website is a **portfolio project**.  
It demonstrates how machine learning pipelines, recommender systems, and web deployment can be integrated.  
It is not a commercial product or production service.
