...
- No login is required to browse the site or use the chatbot. Login is required for personalised recommendations (both on the profile page and via the chatbot).
